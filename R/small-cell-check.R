...
#'
#'@examples
#' small_size_cells(TableOne)
#' small_size_cells(TableOne, small_size=7)
#' small_size_cells(TableOne, small_size=7, print=False)
#' small_size_cells(TableTwo, table_type = "TableTwo)
#'
#'@export
